...
<div class="container">
    ...
    if (isset($_SESSION['user_id'])) {
        // Load JSON file
        $json = file_get_contents('game_dev.json');
    ...
    if (isset($_POST['proficiencyLevel'])) {
        try {
            ...
            $stmt = $pdo->prepare("INSERT INTO user_proficiency (id, game_dev) VALUES (:user_id, :game_dev) ON DUPLICATE KEY UPDATE game_dev = VALUES(game_dev)");

            // Bind parameters and execute statement
            $stmt->bindParam(':user_id', $user_id);
            $stmt->bindParam(':game_dev', $proficiencyLevel);
            $stmt->execute();
...
<script>
    ...
    function submitQuiz() {
        ...
        xhr.open("POST", "game_devEvaluation.php", true);
