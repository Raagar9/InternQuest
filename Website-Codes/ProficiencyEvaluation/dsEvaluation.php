...
<div class="container">
    ...
    if (isset($_SESSION['user_id'])) {
        // Load JSON file
        $json = file_get_contents('ds.json');
    ...
    if (isset($_POST['proficiencyLevel'])) {
        try {
            ...
            $stmt = $pdo->prepare("INSERT INTO user_proficiency (id, ds) VALUES (:user_id, :ds) ON DUPLICATE KEY UPDATE ds = VALUES(ds)");
...
<script>
    ...
    function submitQuiz() {
        ...
        xhr.open("POST", "dsEvaluation.php", true);
